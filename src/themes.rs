...
static MONOKAI_DARK: &[u8; include_bytes!("../themes/Monokai Dark.tmTheme").len()] =
...
pub static THEME_MAP: LazyLock<HashMap<&str, &[u8]>> =
    LazyLock::<HashMap<&str, &[u8]>>::new(|| {
        ...
        theme_map.insert("STARLIGHT", STARLIGHT);
        theme_map.insert("SUCCULENT_1", SUCCULENT_1);
        theme_map.insert("SUMMER_CAMP_DAYBREAK", SUMMER_CAMP_DAYBREAK);
        theme_map.insert("SUMMER_CAMP_MOD", SUMMER_CAMP_MOD);
        theme_map.insert("SUMMER_SUN", SUMMER_SUN);
        theme_map.insert("SUNBURST", SUNBURST);
        theme_map.insert("SWEYLA650478", SWEYLA650478);
        theme_map.insert("SWEYLA674314", SWEYLA674314);
        theme_map.insert("SWYPHS_II", SWYPHS_II);
        theme_map.insert("TANGO_IN_TWILIGHT", TANGO_IN_TWILIGHT);
        theme_map.insert("TANGO", TANGO);
        theme_map.insert("TEK", TEK);
        theme_map.insert(
            "TEXT_EX_MACHINA_LIGHTER_COMMENTS",
            TEXT_EX_MACHINA_LIGHTER_COMMENTS,
        );
        theme_map.insert("TEXT_EX_MACHINA", TEXT_EX_MACHINA);
        theme_map.insert("THEMES", THEMES);
        theme_map.insert("TOMORROW_NIGHT", TOMORROW_NIGHT);
        theme_map.insert("TOMORROWNIGHTBLUE", TOMORROWNIGHTBLUE);
        theme_map.insert("TOMORROWNIGHTBRIGHT", TOMORROWNIGHTBRIGHT);
        theme_map.insert("TOMORROWNIGHTEIGHTIES", TOMORROWNIGHTEIGHTIES);
        theme_map.insert("TOMORROWNIGHT", TOMORROWNIGHT);
        theme_map.insert("TOMORROW", TOMORROW);
        theme_map.insert("TUBSTER", TUBSTER);
        theme_map.insert("TWILIGHT_BRIGHT", TWILIGHT_BRIGHT);
        theme_map.insert("TWILIGHT_REMIX", TWILIGHT_REMIX);
        theme_map.insert("TWILIGHT", TWILIGHT);
        theme_map.insert("UPSTREAM_SUNBURST", UPSTREAM_SUNBURST);
        theme_map.insert("UPSTREAM_VIBRANT", UPSTREAM_VIBRANT);
        theme_map.insert("VENOM", VENOM);
        theme_map.insert("VIBRANT_FIN", VIBRANT_FIN);
        theme_map.insert("VIBRANT_INK_CHOPPEDNSCREWED", VIBRANT_INK_CHOPPEDNSCREWED);
        theme_map.insert("VIBRANT_INK_REMIX", VIBRANT_INK_REMIX);
        theme_map.insert("VIBRANT_INK", VIBRANT_INK);
        theme_map.insert("VIBRANT_TANGO", VIBRANT_TANGO);
        theme_map.insert("VINTAGE_AURORA", VINTAGE_AURORA);
        theme_map.insert("WHYS_POIGNANT", WHYS_POIGNANT);
        theme_map.insert("ZACHSTRONAUT_THEME_4", ZACHSTRONAUT_THEME_4);
        theme_map.insert("ZENBURN", ZENBURN);
        theme_map.insert("ZENBURNESQUE", ZENBURNESQUE);
        theme_map
    });
