...
#[derive(Default)]
pub struct HeaderValueTextInput {
    #[allow(dead_code)]
    component_ids: Rc<RefCell<HashMap<String, ComponentId<String>>>>,
}

impl HeaderValueTextInput {
    pub fn register(
        ...
        ids_ref.insert(String::from("headervalueinput"), id);

        Ok(())
    }
}

impl anathema::component::Component for HeaderValueTextInput {
...
impl InputReceiver for HeaderValueTextInput {}
